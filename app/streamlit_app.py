...
st.markdown("Generate daily flow plots for USGS gages using [hydrolib](https://github.com/pinhead001/hydrolib)")
...
if run_analysis and gage_list:
    ...
    for idx, site_no in enumerate(gage_list):
        ...
        try:
            ...
            info_cols[0].metric("Drainage Area", f"{gage.drainage_area or 'N/A'} sq mi")
            ...
            if show_timeseries:
                ...
                cols[plots_to_show.index("timeseries")].pyplot(fig1)
            ...
            if show_summary:
                ...
                cols[plots_to_show.index("summary")].pyplot(fig2)
            ...
            if show_fdc:
                ...
                cols[plots_to_show.index("fdc")].pyplot(fig3)
